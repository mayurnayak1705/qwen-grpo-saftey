...
model = AutoModelForCausalLM.from_pretrained("heisenberg-goddamnright/qwen-0.5b-grpo-safety-merged",
...
for data in test_data:
    ...
    print(f"reward for {i} iteration is {reward}")
    i = i +1



# Save locally
with open("rl_model_rewards.json", "w") as f:
    json.dump(total_reward_base_model, f)

print("Saved rewards to rl_model_rewards.json")
